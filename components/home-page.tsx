...
const features = [
  {
    ...
    title: "Royal Recipes",
    description:
      "Traditional Nawabi dishes prepared with royal heritage and pride.",
  ...
  },
  {
    ...
    description:
      "Only the best handpicked spices and freshest ingredients.",
  ...
  },
  {
    ...
    title: "Open Late",
    description:
      "Open till 2 AM every day — for those late-night royal cravings.",
  ...
  },
  {
    ...
    title: "Award Winning",
    description:
      "Melbourne’s most celebrated Indian fine-dining destination.",
    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center">
        <div
          ...
          style={{
            backgroundImage: `url('/img.jpg?height=1080&width=1920')`,
          }}
        />
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-yellow-500 hover:bg-yellow-600 text-red-900 font-semibold text-lg px-8 py-3"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white text-black hover:bg-white hover:text-red-900 font-semibold text-lg px-8 py-3"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-red-900 font-semibold text-lg px-8 py-3"
            >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {features.map((f, i) => (
            <div
              key={i}
              className={`bg-gradient-to-br ${f.bg} p-1 rounded-3xl shadow-2xl transition-transform duration-500 hover:scale-105 group`}
            >
              <div className="bg-white rounded-[22px] p-6 h-full text-center">
                ...
                <h3 className="text-xl font-semibold text-[#1c130b] mb-2">
                  {f.title}
                </h3>
                <p className="text-[#4b2f19] text-sm leading-relaxed">
                  {f.description}
                </p>
              </div>
            </div>
...
<section className="py-20 bg-[#fff8e1] relative overflow-hidden">
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      {/* Dish Card */}
      <Card className="overflow-hidden rounded-3xl border border-[#D3AB66] hover:shadow-2xl transition-transform hover:scale-105 bg-white">
        <img
          src="/briyani1.jpg"
        ...
        <CardContent className="p-6 text-center">
          <h3 className="text-2xl font-semibold text-[#1c130b] mb-2">Hyderabadi Biryani</h3>
          <p className="text-[#4b2f19] mb-4 text-sm">
            Aromatic basmati rice layered with tender meat and exotic royal spices.
          </p>
          <Button
            asChild
            variant="outline"
            className="border-[#1c130b] text-[#1c130b] hover:bg-[#1c130b] hover:text-white"
          >
            <Link to="/menu">View Menu</Link>
          </Button>
        </CardContent>
      ...
      <Card className="overflow-hidden rounded-3xl border border-[#D3AB66] hover:shadow-2xl transition-transform hover:scale-105 bg-white">
        ...
        />
        <CardContent className="p-6 text-center">
          <h3 className="text-2xl font-semibold text-[#1c130b] mb-2">Tandoori Delights</h3>
          <p className="text-[#4b2f19] mb-4 text-sm">
            Marinated meats and vegetables grilled in our traditional clay oven.
          </p>
          <Button
            asChild
            variant="outline"
      ...
      <Card className="overflow-hidden rounded-3xl border border-[#D3AB66] hover:shadow-2xl transition-transform hover:scale-105 bg-white">
        ...
        />
        <CardContent className="p-6 text-center">
          <h3 className="text-2xl font-semibold text-[#1c130b] mb-2">Royal Briyani</h3>
          <p className="text-[#4b2f19] mb-4 text-sm">
            Rich, flavorful curries made with heritage spices and timeless techniques.
          </p>
          <Button
            asChild
            variant="outline"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-[#D3AB66] hover:bg-[#c9a54e] text-[#1c130b] font-semibold text-lg px-8 py-3 rounded-full shadow-md"
            >
              <Link to="/contact">Book a Table</Link>
            </Button>
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-[#D3AB66] text-[#D3AB66] hover:bg-[#D3AB66] hover:text-[#1c130b] font-semibold text-lg px-8 py-3 rounded-full shadow-md"
            >
